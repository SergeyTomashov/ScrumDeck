...
fon = pygame.transform.scale(load_image('/Users/a1/PycharmProjects/pythonProject1/map.png'), (1920, 1080))
main_running = True
draging = False
current_coor = None
all_el = []
...
while main_running:
    ...
    text1 = font.render('Character And the Avatar', True, (255, 255, 255))
    text2 = font.render('Dialog and the Text', True, (255, 255, 255))
    screen.blit(text1, (760, 554))
    screen.blit(text2, (790, 660))
